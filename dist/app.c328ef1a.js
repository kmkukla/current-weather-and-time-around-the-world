...
},{"./isObject":"../node_modules/lodash/isObject.js","./now":"../node_modules/lodash/now.js","./toNumber":"../node_modules/lodash/toNumber.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var cityInput = document.querySelector(".weather__search");
var location = document.querySelector(".weather__location-city");
var day = document.querySelector(".weather__date-day");
var time = document.querySelector(".weather__date-time");
var temperature = document.querySelector(".weather__temperature");
var weatherType = document.querySelector(".weather__type");
var weatherIcon = document.querySelector(".weather__icon");
var wind = document.querySelector(".weather__wind");
var pressure = document.querySelector(".weather__pressure");
var sunrise = document.querySelector(".weather__sunrise");
var sunset = document.querySelector(".weather__sunset");
var timeNow;
var weather = {
  timezone: -25200,
  city: "",
  ...
  displayWeather: function displayWeather() {
    ...
    location.textContent = "".concat(this.city, ", ").concat(this.country);
    ...
    timeNow = setInterval(function () {
      var currentTime = (0, _moment.default)(Date.now() + _this.timezone * 1000).utcOffset(0).format("HH:mm:ss");
  ...
  getWeather: function getWeather(_ref) {
    ...
    var latitude = _ref.latitude,
        ...
        city = _ref.city;
    var API_KEY = "e84ea5c52ea447a2e7b086b1965a2b3b";
    var api;

    if (latitude && longitude) {
      api = "https://api.openweathermap.org/data/2.5/weather?lat=".concat(latitude, "&lon=").concat(longitude, "&appid=").concat(API_KEY, "&units=metric");
    } else if (city) {
      api = "https://api.openweathermap.org/data/2.5/weather?q=".concat(city, "&appid=").concat(API_KEY, "&units=metric");
    }

    if (latitude && longitude || city.length > 1) {
      fetch(api).then(function (res) {
        if (!res.ok) throw new Error("Location not found.");else return res;
      }).then(function (res) {
        return res.json();
      }).then(function (res) {
        _this2.timezone = res.timezone;
        _this2.city = res.name;
        _this2.country = res.sys.country;
        _this2.day = (0, _moment.default)(Date.now() + _this2.timezone * 1000).utcOffset(0).format("MMMM Do YYYY");
        _this2.time = (0, _moment.default)(Date.now() + _this2.timezone * 1000).utcOffset(0).format("HH:mm:ss");
        _this2.temperature = "".concat(Math.round(res.main.temp), "\xB0");
        _this2.description = res.weather[0].main;
        _this2.icon = "http://openweathermap.org/img/w/".concat(res.weather[0].icon, ".png");
        _this2.wind = "Wind: ".concat(res.wind.speed, "km/h");
        _this2.pressure = "Pressure: ".concat(res.main.pressure, "hPa");
        _this2.sunrise = "Sunrise: ".concat((0, _moment.default)(new Date(res.sys.sunrise * 1000 + res.timezone * 1000)).utcOffset(0).format("HH:mm"));
        _this2.sunset = "Sunset: ".concat((0, _moment.default)(new Date(res.sys.sunset * 1000 + res.timezone * 1000)).utcOffset(0).format("HH:mm"));

        _this2.displayWeather();
      }).catch(function (err) {
...
function showError(error) {
  ...
  day.textContent = "Enter city name manually or enable access to device location.";
  time.classList.add("weather__date-time--hidden");
}

cityInput.addEventListener("input", (0, _debounce.default)(function () {
  weather.getWeather({
    city: cityInput.value
  });
}, 600));
},{"moment":"../node_modules/moment/moment.js","lodash/debounce":"../node_modules/lodash/debounce.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
